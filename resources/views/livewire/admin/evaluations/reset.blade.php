...
$resetEvaluations = function () {
    $this->validate();

    EvaluationScore::truncate();
    EvaluationTaken::query()->update([
        'answered' => false
    ]);
...
<x-modal name="confirm-evaluations-reset" :show="$errors->isNotEmpty()" focusable>
    <form wire:submit="resetEvaluations" class="p-6">
